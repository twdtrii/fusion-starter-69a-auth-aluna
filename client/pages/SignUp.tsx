  ...
  return (
    <div className="min-h-screen bg-white font-spartan flex flex-col">
      ...
      >
        ...
        <h1 className="text-white text-2xl font-semibold">New Account</h1>
      </div>

      {/* Content */}
      <div className="flex-1 px-8 pt-6 pb-8 overflow-y-auto">
        {/* Form */}
        <form onSubmit={handleSubmit} className="space-y-5">
              ...
              >
                ...
                >
                  <path
                    ...
                    stroke="url(#paint0_linear_pwd)"
                    strokeLinecap="round"
                  />
                  <defs>
                    <linearGradient
                      id="paint0_linear_pwd"
                      x1="10"
                      y1="0"
                      x2="10"
                      y2="16"
          ...
          <div>
            ...
            <input
              ...
              className="w-full h-[45px] rounded-[13px] bg-[#E9F6FE] border border-[#E9F6FE] px-4 text-xl text-[#13CAD6] placeholder:text-[#13CAD6] text-center focus:outline-none focus:ring-2 focus:ring-[#33E4DB]"
            />
          </div>

          {/* Terms */}
          <p className="text-center text-xs leading-tight px-4 mt-4">
            <span className="font-light text-[#252525]">
              By continuing, you agree to{" "}
            </span>
            <span className="font-medium text-[#13CAD6]">Terms of Use</span>
            <span className="font-light text-[#252525]"> and </span>
            <span className="font-medium text-[#13CAD6]">Privacy Policy.</span>
          </p>
          ...
          <div className="flex justify-center gap-3">
            ...
            <button className="w-10 h-10 rounded-full" style={{ background: "linear-gradient(180deg, #33E4DB 0%, #00BBD3 100%)" }}>
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <circle cx="20" cy="20" r="20" fill="url(#paint0_linear_g2)" />
                <path
                ...
                />
                <defs>
                  <linearGradient id="paint0_linear_g2" x1="20" y1="0" x2="20" y2="40" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#33E4DB" />
                    <stop offset="1" stopColor="#00BBD3" />
                  </linearGradient>
                </defs>
            ...
            <button className="w-10 h-10 rounded-full" style={{ background: "linear-gradient(180deg, #33E4DB 0%, #00BBD3 100%)" }}>
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <circle cx="20" cy="20" r="20" fill="url(#paint0_linear_f2)" />
                ...
                />
                <defs>
                  <linearGradient id="paint0_linear_f2" x1="20" y1="0" x2="20" y2="40" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#33E4DB" />
                    <stop offset="1" stopColor="#00BBD3" />
                  </linearGradient>
                </defs>
            ...
            <button className="w-10 h-10 rounded-full" style={{ background: "linear-gradient(180deg, #33E4DB 0%, #00BBD3 100%)" }}>
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <circle cx="20" cy="20" r="20" fill="url(#paint0_linear_fp2)" />
                <path
                ...
                />
                <defs>
                  <linearGradient id="paint0_linear_fp2" x1="20" y1="0" x2="20" y2="40" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#33E4DB" />
                    <stop offset="1" stopColor="#00BBD3" />
                  </linearGradient>
                </defs>
        ...
        <p className="text-center text-xs mt-6">
          <span className="font-light text-[#252525]">already have an account? </span>
          <Link to="/login" className="font-medium text-[#13CAD6]">
            Log in
          </Link>
        </p>
      </div>
